...
public class ItemStackEditor {
    ...
    private ItemStackEditor(ItemStack itemStack,
                            Consumer<ItemMeta> metaTransform,
                            Consumer<ItemStack> stackTransform) {
    ...
    public ItemStackEditor setCustomModel(Integer data) {
        return andMetaConsumer(ItemStackUtil.editCustomModelData(data));
    }
    ...
    public ItemStackEditor withMetaConsumer(Consumer<ItemMeta> consumer) {
        return new ItemStackEditor(this.itemStack, consumer, this.stackTransform);
    }

    public ItemStackEditor withStackConsumer(Consumer<ItemStack> consumer) {
