...
public final class CustomGameProfile {
    ...
    public static GameProfile create(UUID uuid, String texture) {
        if (texture != null) {
    ...
    public static void apply(GameProfile profile, SkullMeta meta, URL skinUrl) throws NoSuchFieldException, IllegalAccessException, UnknownServerVersionException {
